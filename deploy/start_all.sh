...
do
    app=`sudo docker ps -a | grep "bigtony.fileserver.com/filestore/${service}" | awk '{print $1}'`
    if [[ $app != "" ]];then
...
do
    ...
    if [[ $service == "upload" || $service == "download" ]];then
        volumes="-v /Users/bigtony/tmp/fileserver:/data/fileserver -v /Users/bigtony/tmp/fileserver_part:/data/fileserver_part"
    fi
    ...
    sudo docker run -it -d \
      ...
      bigtony.fileserver.com/filestore/${service}
done
