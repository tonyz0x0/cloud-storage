...
ROOT_DIR=~/go/src/filestore-server
services="
dbproxy
upload
download
...
build_image() {
    ...
    sudo docker build -t bigtony.fileserver.com/filestore/$1 -f ./service/$1/Dockerfile .
    echo -e "\033[32m镜像打包完成: \033[0m bigtony.fileserver.com/filestore/$1\n"
}
...
# 容器启动示例
# 启动account service
# docker run -it -e PARAMS="--registry=consul --registry_address=192.168.200.212:8500" bigtony.fileserver.com/filestore/account